...
class ContraceptiveViewController: UIViewController, ContraceptiveDisplayLogic
{
    ...
    var contraceptiveQuesArray = ["No", "I am on the combined pill","I get injections", "I have an implant","I have a coil","I’m on the mini pill (progesterone only)","I have a patch","Other"]
